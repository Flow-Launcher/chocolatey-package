...
$url64bit   = 'https://github.com/Flow-Launcher/Flow.Launcher/releases/download/v1.9.4/Flow-Launcher-Setup.exe' 
...
$packageArgs = @{
  ...
  checksum64      = '4c091fb6e2523ea6a9f6ac8e8b4c84b2dca19f167f31fc3de38e31ba3ad24f89'
